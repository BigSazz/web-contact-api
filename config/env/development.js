...
module.exports = {
  ...
  **************************************************************************/
  datastores: {
    ...
    ***************************************************************************/
    default: {
      adapter: 'sails-mongo',
      url: 'mongodb://admin:admin1234@ds163835.mlab.com:63835/contact-db'
    },

  },

  jwt: {
    secret: 'ieiur884848urjrjrsazzyMan88',
    audience: 'EveryOne',
    issuer: 'HUMBLE-ME',
    exipry: '7d'
  },
  ...
  models: {
    ...
    ***************************************************************************/
    migrate: 'alter',
    dataEncryptionKeys: {
      default: 'H7GN6RGknpLFsPvikc9oPXDkMQDRbE36eYQ815Fix9w=',
    },
  ...
  ***************************************************************************/
  session: {
    secret:'a48dea72c3be0e7df25b1950ecc5abfc',
    /***************************************************************************
    *                                                                          *
